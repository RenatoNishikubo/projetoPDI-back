...
class Endereco(models.Model):
    declarante_id = models.ForeignKey(Declarante, related_name='endereco', on_delete=models.CASCADE)
...
class Propriedade(models.Model):
    declarante_id = models.ForeignKey(Declarante, related_name='propriedade', on_delete=models.CASCADE)
...
class Dependente(models.Model):
    declarante_id = models.ForeignKey(Declarante, related_name='dependente', on_delete=models.CASCADE)
    tipo = models.CharField(max_length=20, default='')
    nome = models.CharField(max_length=150, default='')
